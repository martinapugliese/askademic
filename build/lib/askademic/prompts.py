...
from askademic.constants import ARXIV_RECENT_ARTICLES_BASE_URL
...
USER_PROMPT_SUMMARY_TEMPLATE = cleandoc(
    ...
    5. Also generate the arXiv URL to the most recent papers in the chosen category,
       building it starting from {ARXIV_RECENT_ARTICLES_BASE_URL}, concatenating the category ID and then "/new"
    6. End the process.
    """
)
