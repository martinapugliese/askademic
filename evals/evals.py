...
async def main():
    ...
    console.print("[bold magenta]Running allower evals...[/bold magenta]")
    await run_evals_allower()
    console.print("[bold magenta]Running orchestrator evals...[/bold magenta]")
    await run_evals_orchestrator()
    console.print("[bold magenta]Running summary evals...[/bold magenta]")
    await run_evals_summary()
    console.print("[bold magenta]Running question evals...[/bold magenta]")
    await run_evals_question()
    console.print("[bold magenta]Running article evals...[/bold magenta]")
